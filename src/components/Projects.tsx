...
function Projects() {
  return (
    <section id="projects" className="relative bg-slate-900 px-6 py-24">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-3">
          {portfolio.projects.map((project, index) => (
            <Reveal key={project.title} delay={index * 225}>
              <article className="group flex flex-col rounded-2xl border border-white/10 bg-slate-950 p-6 transition duration-300 hover:-translate-y-2 hover:border-blue-500/30">
      ...
      <SectionArrow
        href="#education"
        label="Ir para a seção Formação"
      />
    </section>
  );
}
